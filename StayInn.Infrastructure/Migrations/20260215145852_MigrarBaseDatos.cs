...
{
    /// <inheritdoc />
    public partial class MigrarBaseDatos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AreasEsparcimiento", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AreasEsparcimiento_Hotel_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AreasEsparcimiento_HotelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservaciones_FechaEntrada_FechaSalida",
                table: "Reservaciones",
