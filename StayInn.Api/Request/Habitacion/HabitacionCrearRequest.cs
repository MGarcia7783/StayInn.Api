...
{
    public class HabitacionCrearRequest
    {
        [Required(ErrorMessage = "La referencia al hotel es requerida.")]
        ...
        [Required(ErrorMessage = "La imagen de la habitación es requerida.")]
